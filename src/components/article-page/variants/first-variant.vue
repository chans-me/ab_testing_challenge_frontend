<template>
  <div>
    <v-card class="pa-lg-8 pa-md-6">
      <v-card-title class="display-2" style="word-break: none !important;">
      ...
      <v-card-actions class="justify-center">
        <v-btn color="primary" x-large @click="$emit('signup')">Start Your Free Trial</v-btn>
      </v-card-actions>
    </v-card>
  </div>
</template>
